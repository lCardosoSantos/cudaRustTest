...
#ifndef FR_REDUCE5_CUH
#define FR_REDUCE5_CUH

#include <cstdint>

#include "ptx.cuh"

__device__ __forceinline__ void fr_reduce5(
    ...
    )
{
    ...
    mul_wide_u32(u0, t9, 0xF0000001);
    mul_wide_u32(u1, t9, 0x43E1F593);
    mul_wide_u32(u2, t9, 0x79B97091);
    mul_wide_u32(u3, t9, 0x2833E848);
