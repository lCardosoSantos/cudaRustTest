...
#ifndef FR_REDUCE4_CUH
#define FR_REDUCE4_CUH

#include <cstdint>

#include "ptx.cuh"

__device__ __forceinline__ void fr_reduce4(
    ...
    )
{
    ...
    mul_wide_u32(u0, q3, 0xF0000001);
    mul_wide_u32(u1, q3, 0x43E1F593);
    mul_wide_u32(u2, q3, 0x79B97091);
    mul_wide_u32(u3, q3, 0x2833E848);
    ...
    sub_cc_u64 (u0, z0, 0x43E1F593F0000001);
    subc_cc_u64(u1, z1, 0x2833E84879B97091);
