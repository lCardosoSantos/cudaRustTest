 ...
 * @return bool 
 */
extern "C"__global__ bool FpTestKAT(bool result, testval_t *testval, const size_t testsize){
    #warning Function not implemented: FpTestKAT
}
 ...
 * @return bool 
 */
extern "C"__global__ bool FpTestFibonacci(bool result, testval_t *testval, const size_t testsize){
    #warning Function not implemented: FpTestKAT
}
